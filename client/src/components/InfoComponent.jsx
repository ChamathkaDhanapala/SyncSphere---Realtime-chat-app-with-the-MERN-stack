...
export default function InfoComponent({ user, open, onClose }) {
  ...
  const handleImageError = (e) => {
    ...
    const fallbackUrl = `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.username || 'U')}&background=3B82F6&color=ffffff&size=150&bold=true`;
      ...
      <div style={styles.modal} onClick={(e) => e.stopPropagation()}>
        ...
        <div style={styles.content}>
          ...
          <div style={styles.infoSection}>
            ...
            <div style={styles.detailItem}>
              ...
              <span style={{...styles.detailValue, color: user?.online ? '#10b981' : '#ef4444'}}>
                {user?.online ? 'Online' : 'Offline'}
              </span>
            </div>
            <div style={styles.detailItem}>
              <span style={styles.detailLabel}>User ID:</span>
              <span style={{...styles.detailValue, fontSize: '12px', fontFamily: 'monospace'}}>
        ...
        <div style={styles.footer}>
          <div style={styles.memberSince}>
            {user?.createdAt ? `Member since ${formatDate(user.createdAt)}` : 'Member since unknown'}
          </div>
        </div>
      </div>
    </div>
